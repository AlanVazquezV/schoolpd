                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">
                                                    <Button class="p-button-text" icon="pi pi-eye" label="User Types Detail" v-if="item.id" @click="app.openPageDialog({ page: 'user_types/view', url: `/user_types/view/${item.id}` , closeBtn: true })" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script setup>
	...
	onMounted(()=>{ 
		const pageTitle = "Permissions Details";
