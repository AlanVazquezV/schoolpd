                        ...
                        <div  class="col-12 md:col-3 " >
                            <template v-if="auth.canView('/permissions/add')">
                                <router-link :to="`/permissions/add`">
                                    <Button label="Add New Permissions" icon="pi pi-plus" type="button" class="p-button bg-primary "  />
                                </router-link>
                            </template>
                        </div>
                        ...
                        <div >
                            ...
                            <div class="page-records"  >
                                <DataTable :lazy="true"   :loading="loading"    v-model:selection="selectedItems"
                                     :value="records" dataKey="permission_id" @sort="onSort($event)" class="" :showGridlines="false" :rowHover="true" responsiveLayout="stack">
                                    <Column selectionMode="multiple" headerStyle="width: 2rem" />
                                        ...
                                        <Column  field="id" header="Id" >
                                            <template #body="{data}">
                                                <Button class="p-button-text" icon="pi pi-eye" label="User Types" v-if="data.id" @click="app.openPageDialog({ page: 'user_types/view', url: `/user_types/view/${data.id}` , closeBtn: true })" />
                                            </template>
                                        </Column>
