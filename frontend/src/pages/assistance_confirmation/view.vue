                        ...
                        <div class="grid align-items-center">
                            ...
                            <div  class="col " >
                                <div class=" text-2xl text-primary font-bold" >
                                    Assistance Confirmation Details
                                </div>
                            </div>
                        </div>
                    </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'assistance_confirmationview',
		},
		apiPath: {
			type: String,
			default: 'assistance_confirmation/view',
		},
		editButton: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'assistance_confirmation/edit', url: `/assistance_confirmation/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = "Assistance Confirmation Details";
