...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'classes_modalityview',
		},
		apiPath: {
			type: String,
			default: 'classes_modality/view',
		},
		editButton: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'classes_modality/edit', url: `/classes_modality/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = "Classes Modality Details";
