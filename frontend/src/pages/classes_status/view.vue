...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'classes_statusview',
		},
		apiPath: {
			type: String,
			default: 'classes_status/view',
		},
		editButton: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'classes_status/edit', url: `/classes_status/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = "Classes Status Details";
