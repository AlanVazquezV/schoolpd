                            ...
                            <div >
                                <div class="mb-3 grid justify-content-start">
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Classes</div>
                                                <div class="font-bold">{{ item.classes }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">User</div>
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Date</div>
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="card flex gap-3 align-items-center p-3 ">
                                            <div class="">
                                                <div class="text-400 font-medium mb-1">Confirmation</div>
                                                <div class="font-bold">{{ item.confirmation }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'assistanceview',
		},
		apiPath: {
			type: String,
			default: 'assistance/view',
		},
		editButton: {
			type: Boolean,
			default: true,
	...
	onMounted(()=>{ 
		const pageTitle = "Assistance Details";
