...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'user_statusview',
		},
		apiPath: {
			type: String,
			default: 'user_status/view',
		},
		editButton: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'user_status/edit', url: `/user_status/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = "User Status Details";
