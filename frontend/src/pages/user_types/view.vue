...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'user_typesview',
		},
		apiPath: {
			type: String,
			default: 'user_types/view',
		},
		editButton: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ page:'user_types/edit', url: `/user_types/edit/${data.id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = "User Types Details";
